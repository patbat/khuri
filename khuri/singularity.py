...
def singularity_curve(decay_mass_2, mass_2, number, points=200, eps=1e-6):
    # The bounds needs to be slightly adapted, for otherwise the
    # general solution to the cubic equation becomes singular (at cos2 == 0, 1
    # the cubic equation reduces to a quadratic one).
